...
const About = () => {
  return (
    <>
      <Head>
        <title>Ahmed Fathy | About page</title>
        <meta
          name="description"
          content="Machine Learning engineer for hiring"
        />
      </Head>
      <TransitionEffect />
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
              ...
              <p className="my-4 font-medium">
                {" "}
                In my work, I use various machine learning techniques such as
                supervised and unsupervised learning, deep learning, and
                reinforcement learning to build predictive models and
                intelligent systems. I am proficient in programming languages
                such as Python, Java, and C++, and I am comfortable working with
                software frameworks such as TensorFlow, PyTorch, and
                Scikit-Learn.
              </p>
              <p className="font-medium">
                {" "}
                In addition to my technical skills, I am a critical thinker, a
                problem solver, and a lifelong learner. I stay up-to-date with
                the latest trends and developments in machine learning and
                software engineering, and I am always seeking new challenges and
                opportunities to grow my skills and expertise.
              </p>
            </div>
            <div
